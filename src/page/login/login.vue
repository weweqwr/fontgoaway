        ...
        <div class="login">
          <div class="login-content">
            ...
            <div class="login_fields__submit">
              <input class="layui-btn layui-btn-normal submit" type='submit' value='登录' v-on:click="login">
            </div>
            <router-link class="goRegister" :to="{name:'register'}" target=_blank>注册</router-link>
          </div>
        ...
        methods: {
            login: function () {
                ...
                if (account != "" && password != "") {
                    ...
                    that.$axios({
                        method: "POST",
                        url: "http://47.102.97.234:9090/doLogin",
                        data: {
                            account: account,
                            password: password
                        },
                        ...
                        if (info.flag == 1) {
                            ...
                            that.state = "尚在认证中";
                            that.infos = "你的账号未通过超级管理员认证、或已禁用！";
                            setTimeout(function () {
                                that.$router.go(0);
                            }, 4000);
                        }
