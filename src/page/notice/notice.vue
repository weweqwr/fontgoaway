        ...
        <div class="authority">
          <div class="authority-head">
            <div class="manage-head">
              <h6 class="layout padding-left manage-head-con">通知管理
              ...
              <div class="offcial-table tr-border margin-big-top clearfix">
                <div class="tr-th clearfix">
                  <div id="controller" style="width: 100%;">
                    ...
                    <div class="fr" style="padding-left: 5px;">
                      <input type="search" placeholder="id/管理员账号"
                ...
                <div class="tr clearfix border-bottom-none" v-for="item in Info.noticeList">
                  <div class="td w20">
                    {{item.id}}
                  </div>
                  <div class="td w20">
                  ...
                  <div class="td w15">
                    <a class="button btn-red text-white" v-if="item.state==1" v-on:click="sheildReply(item.id,0)">禁用</a>
                    <a class="button bg-green-deep" v-if="item.state==0" v-on:click="sheildReply(item.id,1)">启动</a>
                  </div>
                </div>
              </div>
            </div>
    ...
    export default {
        ...
        methods: {
            ...
            baseInfo: function (id, flag) {
                ...
                that.$axios({
                    method: "post",
                    url: "http://47.102.97.234:9090/queryNotices",
                    data: {
                        id: id,
                        flag: flag,
                        curPage: curPage
            ...
            sheildReply: function (id, state) {
                var that = this;
                var state = state
                that.$axios({
                    method: "post",
                    url: "http://47.102.97.234:9090/sheildNotices",
                    data: {
                        id: id,
                        state: state
                    },
