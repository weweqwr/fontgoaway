          ...
          <div class="authority-content">
            <div class="list-content show">
              <div class="offcial-table tr-border margin-big-top clearfix">
                ...
                <div class="tr clearfix border-bottom-none" v-for="item in Info.commentList">
                  <div class="td w20">
                    {{item.id}}
                  </div>
                  <div class="td w20">
    ...
    export default {
        ...
        methods: {
            ...
            baseInfo: function (id, flag) {
                ...
                that.$axios({
                    method: "post",
                    url: "http://47.102.97.234:9090/queryComment",
                    data: {
                        id: id,
                        flag: flag,
                        curPage: curPage
            ...
            sheildReply: function (id, state) {
                ...
                that.$axios({
                    method: "post",
                    url: "http://47.102.97.234:9090/sheildComment",
                    data: {
                        id: id,
                        state: state
                    },
