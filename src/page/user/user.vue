          ...
          <div class="authority-content">
            <div class="list-content show">
              <div class="offcial-table tr-border margin-big-top clearfix">
                <div class="tr-th clearfix">
                  <div id="controller" style="width: 100%;">
                    ...
                    <div class="fr" style="padding-left: 5px;">
                      <input type="search" placeholder="用户"
                ...
                <div class="tr clearfix border-bottom-none" v-for="item in Info.userList">
                  <div class="td w20">
                    {{item.id}}
                  </div>
                  <div class="td w20">
                  ...
                  <div class="td w15">
                    <img v-bind:src="item.avatarUrl" style="width: 55px;height: 50px;">
                  </div>
                  <div class="td w15">
                    {{item.openid}}
                  </div>
    ...
    export default {
        ...
        methods: {
            ...
            baseInfo: function (id) {
                ...
                that.$axios({
                    method: "post",
                    url: "http://47.102.97.234:9090/queryUser",
                    data: {
                        curPage:curPage,
                        id:id
                    },
            ...
            shieildGroup: function (id, state) {
                ...
                that.$axios({
                    method: "post",
                    url: "http://47.102.97.234:9090/shieldUser",
                    data: {
                        id: id,
                        state: state
                    },
            ...
            loadAdmin:function () {
                ...
                that.admin = admin;
                that.navList=navList;var that = this;
                var admin = JSON.parse(localStorage.getItem("admin"));
                console.log(admin)
                that.admin = admin
            }
